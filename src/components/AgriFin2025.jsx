...
const AgriFin2025 = () => {
  return (
    <PageTransition>
      <Helmet>
        <title>AgriScanAI at AgriFin Learning Event 2025 - AgriScanAI</title>
        <meta name="description" content="AgriScanAI showcased at the 9th Annual AgriFin Learning Event (ALE 2025)" />
      </Helmet>
      ...
      <div className="flex flex-col min-h-screen bg-white">
        ...
        <article className="w-full py-12 md:py-16 lg:py-20">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <img 
              src="/images/events/agrifin_hero_image.png" 
